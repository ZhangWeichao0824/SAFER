...
if __name__ == '__main__':
    ...
    parser.add_argument('--method', type=str, choices=["bare", 'lwf', 'gem', 'safer', 'ewc', 'mas', 'twp', 'jointtrain', 'ergnn', 'joint', 'Joint', 'nvcgl'], default="bare", help="baseline continual learning method")
    ...
    parser.add_argument('--GPS-args', default={'num_layers': 3, 'attn_heads': 4, 'dropout': 0.1, 'local_act': 'relu' })
    parser.add_argument('--GIN-args', default={'h_dims': [32], 'dropout': 0.0})
    ...
    parser.add_argument('--safer_args', type=str2dict, default={'prompts': [3], 'pe': [0.2], 'pf': [0.3]})
    ...
    backbone_args = {'GCN': args.GCN_args, 'GAT': args.GAT_args, 'GIN': args.GIN_args, 'SGC': args.SGC_args, 'GPS': args.GPS_args,}
